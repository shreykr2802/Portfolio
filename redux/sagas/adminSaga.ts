...
import { insertNewTagFailed, insertNewTagStart, insertNewTagSuccess } from "../slices/adminSlice";
import { ResponseGenerator } from "../types";

export function* adminSaga(action: PayloadAction<any>) {
    try {
...
export function* watchAdmin() {
    yield takeLatest(insertNewTagStart, adminSaga);
}
